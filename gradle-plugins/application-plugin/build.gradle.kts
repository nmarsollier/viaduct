...
mavenPublishing {
    ...
    // Resulting artifactId will be "application-gradle-plugin"
    configure(GradlePublishPlugin())
    coordinates(group as String, "application-gradle-plugin", version.toString())

    pom {
        name.set("Viaduct Application Gradle Plugin")
